...
const FeaturesSection = () => (
  <section className="w-full py-20 flex flex-col items-center animate-fadeUp bg-gradient-to-br from-[#181c2f] via-[#23244a] to-[#101a2a]" id="features">
    <h2 className="text-5xl md:text-6xl font-bold mb-16 text-center text-white font-sans animate-fadeUp" style={{letterSpacing:'-0.02em', textShadow:'0 2px 16px #a084ee88'}}>Why Choose LUMÉRA AI</h2>
    <div className="flex flex-col md:flex-row gap-12 justify-center items-stretch w-full max-w-[1600px] px-2 md:px-8">
      ...
      <div className="glass-card flex-1 p-14 flex flex-col items-center text-center min-w-[320px] max-w-[500px] mx-auto animate-float" style={{color:'#fff', fontFamily:'Poppins, Inter, sans-serif'}}>
        ...
        <h3 className="font-bold text-2xl md:text-3xl mb-3 text-white font-sans">Advanced AI Technology</h3>
        <p className="text-lg md:text-xl text-[#b3b8e0] font-medium">Powered by state-of-the-art Convolutional Neural Networks for accurate facial attribute detection</p>
      </div>
      {/* Card 2 */}
      <div className="glass-card flex-1 p-14 flex flex-col items-center text-center min-w-[320px] max-w-[500px] mx-auto border-2 border-[#a084ee] animate-float" style={{color:'#fff', fontFamily:'Poppins, Inter, sans-serif', boxShadow:'0 8px 40px 0 #a084ee33'}}>
        ...
        <h3 className="font-bold text-2xl md:text-3xl mb-3 text-white font-sans">Privacy Protected</h3>
        <p className="text-lg md:text-xl text-[#b3b8e0] font-medium">Your data is encrypted end-to-end. Detailed analysis only with explicit consent</p>
      </div>
      {/* Card 3 */}
      <div className="glass-card flex-1 p-14 flex flex-col items-center text-center min-w-[320px] max-w-[500px] mx-auto animate-float" style={{color:'#fff', fontFamily:'Poppins, Inter, sans-serif'}}>
        ...
        <h3 className="font-bold text-2xl md:text-3xl mb-3 text-white font-sans">Detailed Reports</h3>
        <p className="text-lg md:text-xl text-[#b3b8e0] font-medium">Get comprehensive analysis with confidence scores and downloadable PDF reports</p>
      </div>
    </div>
  </section>
);
